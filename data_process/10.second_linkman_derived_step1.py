...
# # 输入输出路径
# INPUT_FILE = '/data/aiimport_1119/手机号关联其他联系人衍生.csv'
# OUTPUT_DIR = '/data/processed/second_linkman_derived'

# # 确保输出目录存在
# Path(OUTPUT_DIR).mkdir(parents=True, exist_ok=True)

# # 读取全量数据
# usecols = ['cid', 'second_mobile_phone', 'create_date']
...
# 输入输出路径
INPUT_FILE = '/data/aiimport_1119/手机号关联其他联系人衍生.csv'
OUTPUT_DIR = '/data/processed_v3/second_linkman_derived'
